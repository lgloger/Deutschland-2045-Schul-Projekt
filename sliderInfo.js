...
const secondSectionDescription = document.getElementById("secondSectionDescription");
...
const fachkraeftemangelSlider = document.getElementById("fachkraeftemangelSlider");
const fachkraeftemangelText = document.getElementById("fachkraeftemangelText");

const arbeitszeitmodelleSlider = document.getElementById("arbeitszeitmodelleSlider");
const arbeitszeitmodelleText = document.getElementById("arbeitszeitmodelleText");


const optionOneDescription = "Deutschland handelt früh: Bildung, Zuwanderung und KI werden gezielt gesteuert. Staat und Wirtschaft investieren gemeinsam, Bürokratie wird abgebaut. Das senkt den Fachkräftemangel deutlich und stabilisiert soziale Systeme.";
const optionTwoDescription = "Deutschland setzt Reformen um, aber langsamer und oft kompromissgetrieben. Es gibt Verbesserungen bei Ausbildung und Digitalisierung, jedoch bleiben Engpässe in Pflege und Handwerk spürbar. Die Lage stabilisiert sich, aber nicht überall.Deutschland setzt Reformen um, aber langsamer und oft kompromissgetrieben. Es gibt Verbesserungen bei Ausbildung und Digitalisierung, jedoch bleiben Engpässe in Pflege und Handwerk spürbar. Die Lage stabilisiert sich, aber nicht überall.";
const optionThreeDescription = "Reformen werden verschleppt. Bürokratie bleibt hoch, Weiterbildung und Digitalisierung kommen zu spät. Zuwanderung wird nicht aktiv gesteuert, Pflege und Bildung geraten unter Druck. Unternehmen verlagern Aufgaben, soziale Spannungen steigen.";
